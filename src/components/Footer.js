...
import {FaFacebookF,FaInstagram,FaTwitter,FaYoutube,FaTelegram,FaMedium} from "react-icons/fa";
            ...
            <div className="container">
                <div className="footer_social">
                    <ul className='social_links'>
                        ...
                        <li><a target="_blank" href="https://medium.com/@zrodev/protocol-zero-dcf8de91f0e1"><FaMedium className='icon'/></a></li>
