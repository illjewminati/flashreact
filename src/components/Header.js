                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav ms-auto mb-lg-0">
                                <li className="nav-item">
                                    <a className="nav-link" aria-current="page" href="#tokenomics">TOKEN</a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" aria-current="page" href="#services">Q & A</a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a className="AppLaunce nav-link" aria-current="page" href="https://app.nogas.pro/swap" ref='noreferrer'>
                                        LAUNCH APP
                                    </a>
                                </li>
                            </ul>
